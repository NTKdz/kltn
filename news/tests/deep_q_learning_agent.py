    ...
    def train(self, save_path="multi_user_checkpoint.pth", plot_path="multi_user_training_progress.png"):
        ...
        for i in range(T):
            ...
            if (i + 1) % step == 0:
                ...
                if (i + 1) == 100000:
                    self.plot_progress(total_history, per_user_history, "multi_user_progress_at_100k_2.png")
...
if __name__ == "__main__":
    agent = DeepQLearningAgent(load_path="multi_user_checkpoint_2.pth")
    avg_total_multi, avg_per_user_multi = agent.train(
        save_path="multi_user_checkpoint_2.pth",
        plot_path="multi_user_training_progress_2.png"
    )
